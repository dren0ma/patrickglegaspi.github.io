...
function display_content(){
	...
	// $filter = isset($_GET['category']) ? $_GET['category'] : 'All';    ternary
	...
	foreach ($categories as $category) {
		...
		// echo $filter == $category ? "<option selected>$category</option>" : "<option>$category</option>";   ternary
	}
	echo "</select>";
	echo "<button class='btn'>Search</button></form>";
